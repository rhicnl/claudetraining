...
- Verify coding standards defined in `CLAUDE.md`, `CURSOR.md` (if available) and `ai_docs/best-practices/`
...
5. ANALYZE each changed file against:
   - Security issies
   - Code style compliance
   - Proper error handling
   - Test coverage
6. WRITE the review report to `app-reviews/code-review-{date}.md`
